...
export default function SignUpPage() {
  return (
    <div className="fixed inset-0 overflow-hidden bg-zinc-950 flex flex-col">
      <Link
        href="/"
        className="absolute top-4 left-4 sm:top-6 sm:left-6 text-zinc-400 hover:text-zinc-100 text-sm transition-colors z-10 shrink-0"
      >
        ← Back
      </Link>
      ...
      <SignUpFormGuard>
        <div className="flex-1 min-h-0 flex items-center justify-center p-4 overflow-hidden">
          <div className="w-full max-w-[400px] flex flex-col items-center h-full max-h-full overflow-hidden">
            ...
            <div className="w-full flex-1 min-h-0 overflow-y-auto [scrollbar-gutter:stable] rounded-xl">
              <SignUp
                appearance={{
                  layout: {
